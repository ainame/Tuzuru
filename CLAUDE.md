...
- `swift run tuzuru add` - Add new content
- `swift run tuzuru preview` - Preview generated site
- `swift run tuzuru watch` - Watch for changes and regenerate
...
- Generated output: `site/` directory
